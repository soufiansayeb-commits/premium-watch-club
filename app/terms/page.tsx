...
const sections = [
  { id: 's1',  label: 'About This Competition' },
  { id: 's2',  label: 'Eligibility' },
  { id: 's3',  label: 'How to Enter' },
  { id: 's4',  label: 'Skill-Based Question Requirement' },
  { id: 's5',  label: 'The Draw Process' },
  { id: 's6',  label: 'Winner Notification' },
  { id: 's7',  label: 'Prize Delivery' },
  { id: 's8',  label: 'Cash Alternative' },
  { id: 's9',  label: 'Refunds & Failed Payments' },
  { id: 's10', label: 'Responsible Entry' },
  { id: 's11', label: 'Governing Law' },
]
      ...
      <main className="legal-layout">
        <div className="legal-doc">
          ...
          <div className="legal-body">
            ...
            <section id="s8" className="legal-section">
            ...
            <section id="s9" className="legal-section">
            ...
            <section id="s10" className="legal-section">
            ...
            <section id="s11" className="legal-section">
