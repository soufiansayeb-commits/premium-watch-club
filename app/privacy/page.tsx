...
const sections = [
  { id: 'p1', label: 'Who We Are' },
  { id: 'p2', label: 'What Data We Collect' },
  { id: 'p3', label: 'Order & Payment Data' },
  { id: 'p4', label: 'Email Communications' },
  { id: 'p5', label: 'Cookies & Analytics' },
  { id: 'p6', label: 'How We Store Your Data' },
  { id: 'p7', label: 'Your Rights' },
  { id: 'p8', label: 'Contact for Privacy Requests' },
]
      ...
      <main className="legal-layout">
        <div className="legal-doc">
          ...
          <div className="legal-body">
            ...
            <section id="p1" className="legal-section">
              <h2>1. Who We Are</h2>
            ...
            <section id="p2" className="legal-section">
            ...
            <section id="p3" className="legal-section">
            ...
            <section id="p4" className="legal-section">
            ...
            <section id="p5" className="legal-section">
            ...
            <section id="p6" className="legal-section">
            ...
            <section id="p7" className="legal-section">
              <h2>7. Your Rights</h2>
            ...
            <section id="p8" className="legal-section">
